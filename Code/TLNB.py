...
def main():
	...
	for j in range(len(temp)):
		print("***********" + temp[j])
		full_data, scaler = load_data("E:/Code/CEEMDAN-LSTM--master/csv/NB/data-" + temp[j] + "-1.csv")
		...
		for imf in tlceemdan_imfs:
			...
			model = keras.models.load_model("E:/Code/CEEMDAN-LSTM--master/ModelSave/NB/CEEMDAN-LSTM-imf" + str(i) + ".h5")
